...
@jit(nopython=True)
def generateANN(rowUValues, rowDValues, epochTeRMSEValues, epochVaRMSEValues,epocsToDo, df_tr, df_va,df_te, weights, biases, stepSize, hiddenNodes, inputs):
    for curEpoch in range(1, epocsToDo+1, 1):
        ...
        for row in range(0, len(df_tr), 1):
            ...
            outputD = ((df_tr[row, inputs])-U)*(U*(1-U))
        ...
        #print (testRMSE)
        #print (weights)
generateANN(rowUValues, rowDValues, epochTeRMSEValues, epochVaRMSEValues,epocsToDo, df_tr, df_va,df_te, weights, biases, stepSize, hiddenNodes, inputs)
#print (biases)
#print (weights)
